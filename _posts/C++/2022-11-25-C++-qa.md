...
```
solution: add this shared library into system runtime. You can add cmd below in `~/.bsharc` or run it in terminal.
```bash
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/lib/path # replace with your library path
```