...
| OpenCV version       | Required C++ standard                                     | Notes                                             |
| -------------------- | --------------------------------------------------------- | ------------------------------------------------- |
| OpenCV 2.x           | C++98                                                     | legacy                                            |
| OpenCV 3.x           | C++11                                                     | introduced modern C++ usage                       |
| OpenCV 4.0 → 4.6     | C++11                                                     | officially required                               |
| OpenCV 4.7 → 4.9     | C++11 (fully supported), C++17(supported and recommended) | many internal parts optionally use newer features |
| OpenCV 5.0 and later | **C++17 required**                                        | minimum standard raised                           |

| OpenCV version      | VS2022 support                                   |
| ------------------- | ------------------------------------------------ |
| ≤ 4.6.x             | No official prebuilt VS2022 binaries             |
| **4.7.0+**          | ✔ Official prebuilt binaries with VS2022 support |
| 4.8.x, 4.9.x, 4.10+ | ✔ Full native support                            |
| 5.x                 | ✔ Fully supports VS2022                          |

| Recommended | Reason                           |
| ----------- | -------------------------------- |
| **4.9.x**   | Very stable with VS2022          |
| **4.10.x+** | Fully supported modern release   |
| **5.x**     | Latest architecture improvements |

Avoid using < 4.7.0 if you want default prebuilt binaries.
